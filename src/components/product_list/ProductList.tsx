    ...
    return (<>
        ...
        <div className="categoryBox">
            <div className="carosel-button"
                onClick={() => {
                    const res = carouselOperation(categoryCarousel, 30)
                    if (categoryCarousel < 0) carousel(res, categoryBoxRef, setCategoryCarousel)
                }}>&#60;</div>
            <fieldset className="categoryListBox">

                <div className="categoryListBoxChilld"
                    style={{ maxWidth: `${category.length * 10}vw` }}
                    ref={categoryBoxRef}>
            ...
            <div className="carosel-button"
                onClick={() => {
                    const res = carouselOperation(categoryCarousel, -30)
                    if (scope(categoryCarousel, category)) carousel(res, categoryBoxRef, setCategoryCarousel)
                }}>&#62;
            </div></div>
